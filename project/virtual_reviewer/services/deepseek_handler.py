...
class ChatDeepSeek:
	...
	def invoke(self, messages):
		"""
		Sends a message list to the DeepSeek API and returns the response content
		Inputs:
			messages (list): A list of message dictionaries with roles and content
		Output:
			str: The generated response content from DeepSeek
		"""
...
class DeepSeekHandler:
	...
	def invoke(self, messages):
		"""
		Sends messages to the DeepSeek model and returns the trimmed response
		Inputs:
			messages (list): A list of message dictionaries
		Output:
			str: The trimmed response content
		"""
	...
	def generate_review(self, prompt):
		"""
		Generates a structured review from a prompt using DeepSeek.
		Inputs:
